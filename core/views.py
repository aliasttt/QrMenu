...
def landing(request):
    testimonials = [
        {"name": "Nina Park", "role": _("Owner, Basil House"), "quote": _("We increased table turnover with faster ordering.")},
        {"name": "Armin Cole", "role": _("Manager, South Fork"), "quote": _("Campaigns helped us fill off-peak hours.")},
        {"name": "Lara Kim", "role": _("Founder, Luna Cafe"), "quote": _("Our staff now spends less time taking manual orders.")},
    ]
    features = [
        _("AI menu import"),
        _("Multilingual menus"),
        _("QR code generation"),
        _("Order management"),
        _("Campaign engine"),
        _("Daily analytics"),
        _("Category controls"),
        _("Live availability"),
        _("POS-ready payloads"),
        _("Mobile-first pages"),
        _("Role-ready panel"),
        _("Conversion focused UI"),
    ]
    return render(
        request,
        "pages/landing.html",
...
def features(request):
    feature_list = [
        {"title": _("AI menu import"), "desc": _("Upload a PDF or photo and we extract your dishes and prices automatically."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z\"/></svg>"},
        {"title": _("Multilingual menus"), "desc": _("Serve your menu in multiple languages and switch by customer preference."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18m8.129-8.5A18.022 18.022 0 0119.588 9\"/></svg>"},
        {"title": _("QR code generation"), "desc": _("Generate and download QR codes for tables, takeaway, and delivery."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z\"/></svg>"},
        {"title": _("Order management"), "desc": _("Receive, track, and fulfill orders from one dashboard with status updates."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01\"/></svg>"},
        {"title": _("Campaign engine"), "desc": _("Create time-based discounts, happy hours, and target specific categories."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z\"/></svg>"},
        {"title": _("Daily analytics"), "desc": _("View orders, revenue, and top items with simple charts and exports."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z\"/></svg>"},
        {"title": _("Category controls"), "desc": _("Organize items into categories and reorder with drag-and-drop."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 6h16M4 10h16M4 14h16M4 18h16\"/></svg>"},
        {"title": _("Live availability"), "desc": _("Mark items as out of stock and hide or show sections by schedule."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z\"/></svg>"},
        {"title": _("POS-ready payloads"), "desc": _("Send orders to your POS or kitchen display via webhooks or API."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z\"/><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M15 12a3 3 0 11-6 0 3 3 0 016 0z\"/></svg>"},
        {"title": _("Mobile-first pages"), "desc": _("Menus and checkout are optimized for phones and tablets."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z\"/></svg>"},
        {"title": _("Role-ready panel"), "desc": _("Invite staff with roles: admin, manager, or view-only."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z\"/></svg>"},
        {"title": _("Conversion focused UI"), "desc": _("Clean design and clear CTAs to maximize add-to-cart and checkout."), "icon": "<svg class=\"h-6 w-6\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M13 10V3L4 14h7v7l9-11h-7z\"/></svg>"},
    ]
    faqs = [
        {"q": _("Can I use my own domain?"), "a": _("Yes. You can connect a custom domain (e.g. menu.yourrestaurant.com) from the settings panel.")},
        {"q": _("Is there a mobile app for staff?"), "a": _("The panel is fully responsive; you can use it from any browser. Native apps are on our roadmap.")},
        {"q": _("How do I print QR codes?"), "a": _("Generate QR codes from the dashboard and download as PNG or SVG. Print on table tents or stickers.")},
        {"q": _("Do you integrate with POS?"), "a": _("We support webhooks and an API so you can push orders to your POS or kitchen display system.")},
    ]
...
def how_it_works(request):
    steps = [
        {"num": 1, "title": _("Set up your menu"), "desc": _("Create categories, add dishes with prices and photos, and set availability."), "detail": _("Drag-and-drop reorder, bulk edit, or import from spreadsheet.")},
        {"num": 2, "title": _("Generate your QR"), "desc": _("Print QR codes for each table or area. Customers scan to open your menu."), "detail": _("Download PNG or SVG, print on table tents or stickers.")},
        {"num": 3, "title": _("Get online orders"), "desc": _("Customers browse, add to cart, and checkout. You receive and fulfill orders."), "detail": _("Optional: connect to POS or kitchen display.")},
    ]
...
def pricing(request):
    ...
    plan = {
        ...
        "features": [
            _("QR menu — customers scan and browse your menu on their phone"),
            _("Unlimited menu items and categories"),
            _("Unlimited QR codes for tables and takeaway"),
            _("Online ordering — guests order and pay from the same link"),
            _("Customizable themes to match your brand"),
            _("Campaigns & discounts (happy hour, daily specials)"),
            _("Multilingual menu support"),
            _("Real-time updates — change prices and availability instantly"),
            _("Basic analytics — see what sells"),
            _("Email & WhatsApp support"),
        ],
    }
    benefits = [
        {"title": _("Win more orders"), "text": _("Guests order directly from the QR menu. No waiting for staff—faster turnover and higher revenue.")},
        {"title": _("Look professional"), "text": _("A clean digital menu and your own domain build trust. Stand out from competitors still using paper.")},
        {"title": _("One subscription, everything included"), "text": _("No per-order fees or hidden costs. One annual fee covers menu, ordering, and support.")},
        {"title": _("Launch in minutes"), "text": _("Add your dishes, print a QR code, and go live. No IT or design skills needed.")},
    ]
    faqs = [
...
SERVICE_PAGES = [
    {
        "slug": "ai-menu-import",
        "title": _("AI Menu Import"),
        "tagline": _("Turn paper menus into digital menus in minutes."),
        "summary": _("Upload a photo or PDF and let AI extract dish names, descriptions, and prices automatically."),
        "hero_image": "https://images.unsplash.com/photo-1489515217757-5fd1be406fef?w=1400&q=80",
        "benefits": [
            _("Save hours of manual typing"),
            _("Launch your QR menu faster"),
            _("Reduce human data-entry errors"),
        ],
    },
    {
        "slug": "customizable-themes",
        "title": _("Customizable Themes"),
        "tagline": _("Match your menu design to your restaurant brand."),
        "summary": _("Choose from modern themes and customize colors, typography, and layout in a few clicks."),
        "hero_image": "https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=1400&q=80",
        "benefits": [
            _("Consistent brand identity"),
            _("Better visual experience for guests"),
            _("Faster edits with pre-built styles"),
        ],
    },
    {
        "slug": "dedicated-support",
        "title": _("Dedicated Support"),
        "tagline": _("Real help when you need it most."),
        "summary": _("Our team helps with setup, menu updates, and optimization so your staff can focus on service."),
        "hero_image": "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1400&q=80",
        "benefits": [
            _("Priority support for urgent issues"),
            _("Faster onboarding for new branches"),
            _("Better uptime and smoother operations"),
        ],
    },
    {
        "slug": "menu-creation",
        "title": _("Menu Creation"),
        "tagline": _("Build clean, organized menus your guests love."),
        "summary": _("Create categories, add dish photos, set prices, and reorder items with a simple dashboard."),
        "hero_image": "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1400&q=80",
        "benefits": [
            _("Unlimited menu items"),
            _("Quick editing for daily changes"),
            _("Clear structure for better ordering"),
        ],
    },
    {
        "slug": "multi-service-management",
        "title": _("Multi-Service Management"),
        "tagline": _("Run dine-in, takeaway, and delivery from one panel."),
        "summary": _("Manage service types, availability, and order flow in one place without switching tools."),
        "hero_image": "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1400&q=80",
        "benefits": [
            _("One dashboard for all channels"),
            _("Less staff confusion"),
            _("Higher operational speed"),
        ],
    },
    {
        "slug": "multilingual-support",
        "title": _("Multilingual Support"),
        "tagline": _("Serve local and international guests better."),
        "summary": _("Offer your menu in multiple languages and let customers switch language instantly."),
        "hero_image": "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=1400&q=80",
        "benefits": [
            _("Better guest experience for tourists"),
            _("Fewer ordering mistakes"),
            _("Higher conversion on the menu page"),
        ],
    },
    {
        "slug": "online-ordering",
        "title": _("Online Ordering"),
        "tagline": _("Take orders directly from the QR menu."),
        "summary": _("Guests browse, add to cart, and checkout from their phone with a smooth mobile-first flow."),
        "hero_image": "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1400&q=80",
        "benefits": [
            _("Increase average order value"),
            _("Reduce table waiting time"),
            _("Capture more takeaway orders"),
        ],
    },
    {
        "slug": "pdf-export",
        "title": _("PDF Export"),
        "tagline": _("Keep digital and printed menus in sync."),
        "summary": _("Export your latest menu as PDF for table cards, flyers, and offline sharing."),
        "hero_image": "https://images.unsplash.com/photo-1517842645767-c639042777db?w=1400&q=80",
        "benefits": [
            _("Ready-to-print output"),
            _("Consistent branding across channels"),
            _("Simple backup of menu data"),
        ],
    },
    {
        "slug": "real-time-updates",
        "title": _("Real-Time Updates"),
        "tagline": _("Update prices and stock instantly."),
        "summary": _("Publish menu changes live in seconds so guests always see accurate information."),
        "hero_image": "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1400&q=80",
        "benefits": [
            _("No stale menu data"),
            _("Fewer customer complaints"),
            _("Faster reaction to peak-hour demand"),
        ],
    },
    {
        "slug": "secure-payment-processing",
        "title": _("Secure Payment Processing"),
        "tagline": _("Accept payments safely and confidently."),
        "summary": _("Support secure online checkout with trusted gateways and encrypted transaction flow."),
        "hero_image": "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=1400&q=80",
        "benefits": [
            _("Safer transactions"),
            _("More trust from customers"),
            _("Higher checkout completion"),
        ],
    },
    {
        "slug": "smart-order-management",
        "title": _("Smart Order Management"),
        "tagline": _("Track every order in one clean queue."),
        "summary": _("Filter by status, prioritize prep, and keep front-of-house and kitchen fully synchronized."),
        "hero_image": "https://images.unsplash.com/photo-1461344577544-4e5dc9487184?w=1400&q=80",
        "benefits": [
            _("Clear workflow for staff"),
            _("Faster fulfillment"),
