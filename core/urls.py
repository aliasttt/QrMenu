...
urlpatterns = [
    ...
    path("privacy-policy/", views.privacy_policy, name="privacy_policy_alias"),
    path("datenschutz/", views.privacy_policy, name="datenschutz"),
    path("menuterms/", views.terms_conditions, name="terms_conditions_legacy"),
    path("terms/", views.terms_conditions, name="terms_conditions"),
    path("agb/", views.terms_conditions, name="agb"),
    path("agb-b2b/", views.terms_conditions, name="agb_b2b"),
    path("impressum/", views.impressum, name="impressum"),
    path("account/delete/", views.account_delete, name="account_delete"),
    path("delete-account/", views.account_delete, name="account_delete_alias"),
