...
from .views import (
    ...
    AdminSubscriptionNotificationView,
    AdminSubscriptionRestoreView,
    AdminSubscriptionVerifyView,
...
urlpatterns = [
    ...
    path('admin/subscription/', AdminSubscriptionView.as_view(), name='admin_subscription'),
    path(
        'admin/subscription/apple/verify/',
        AdminSubscriptionVerifyView.as_view(provider='apple'),
        name='admin_subscription_apple_verify',
    ),
    path(
        'admin/subscription/google/verify/',
        AdminSubscriptionVerifyView.as_view(provider='google'),
        name='admin_subscription_google_verify',
    ),
    path('admin/subscription/restore/', AdminSubscriptionRestoreView.as_view(), name='admin_subscription_restore'),
    path(
        'admin/subscriptions/apple/notifications/',
        AdminSubscriptionNotificationView.as_view(provider='apple'),
        name='admin_subscription_apple_notifications',
    ),
    path(
        'admin/subscriptions/google/notifications/',
        AdminSubscriptionNotificationView.as_view(provider='google'),
        name='admin_subscription_google_notifications',
    ),
